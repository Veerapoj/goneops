...
export type QuickStartLiveAutomationResult = { workspacePath: string; composeProject: string; repositoryUrl: string; pipelineUrl: string; sandboxUrl: string; liveFrontendUrl: string; liveApiUrl: string; steps: QuickStartAutomationStep[]; logs: string[] };
...
export type GenerateQuickStartResponse = {
  ...
  automation: { mode: "local-self-hosted"; sourceControl: "Gitea"; cicd: "Woodpecker CI"; runtime: "Docker Compose"; repositoryUrl: string; pipelineUrl: string; sandboxUrl: string; liveFrontendUrl?: string; liveApiUrl?: string; workspacePath?: string; composeProject?: string; steps: QuickStartAutomationStep[]; logs: string[] };
